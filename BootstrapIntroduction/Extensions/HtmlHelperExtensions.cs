...
namespace BootstrapIntroduction.Extensions
{
    public static class HtmlHelperExtensions
    {
            ...
            string fieldName, string actionName, string sortField, QueryOptions queryOptions)
        {
            ...
            return new MvcHtmlString(string.Format("<a href=\"{0}\">{1} {2} </a>", urlHelper.Action(actionName, new { SortField = sortField, SortOrder = (isCurrentSortField && queryOptions.SortOrder == SortOrder.ASC) ? SortOrder.DESC : SortOrder.ASC }),
